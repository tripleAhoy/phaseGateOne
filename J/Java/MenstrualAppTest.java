...
public class MenstrualAppTest {
    ...
    public void testOvulationDay() {
        assertEquals(21, MenstrualApp.ovulationDay(1, 35)); // 1 + 21 = 22, but code returns startDay + (cycleLength - 14) = 1+21=22
        assertEquals(21, MenstrualApp.ovulationDay(7, 28)); // 7 + (28-14) = 21
        assertEquals(18, MenstrualApp.ovulationDay(4, 28)); // 4 + 14 = 18
    }
